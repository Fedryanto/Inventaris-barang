    ...
    <div class="row">
        <div class="col-sm-12" align="center">  
            <img src="<?php echo base_url('assets/img/logo/logo.png');?>" width="768px" height="100px">
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                    <h4 class="m-t-0 header-title" style="text-align: center;"><b>LAPORAN DATA PENERIMAAN INVENTARIS SEKOLAH</b></h4>
                ...
                <table class="table table-bordered">
                    ...
                    <?php $i=1?>
                    <?php foreach($penerimaan->result() as $data):?>
                    <tr>
                        <td><?php echo $i++;?></td>
                        <td><?php echo $data->no_terima;?></a></td>
                        <td><?php echo $data->nama_petugas;?></td>
                        <td><?php echo $data->tgl_terima; ?> <?= $data->jam_terima ?></td>
                    </tr>
                    <?php endforeach;?>
                </table>
