									...
									<form action="<?= base_url('pengguna/proses_ubah/' . $pengguna->id) ?>" id="form-tambah" method="POST">
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="kode"><strong>Kode Administrator</strong></label>
												<input type="text" name="kode" placeholder="Masukkan Kode Administrator" autocomplete="off" class="form-control" required value="<?= $pengguna->kode ?>" maxlength="8" readonly>
											</div>
											<div class="form-group col-md-6">
												<label for="nama"><strong>Nama Administrator</strong></label>
												<input type="text" name="nama" placeholder="Masukkan Nama Administrator" autocomplete="off" class="form-control" required value="<?= $pengguna->nama ?>">
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-6">
