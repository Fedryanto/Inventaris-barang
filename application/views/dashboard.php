						...
						<div class="col-md-6">
							<div class="card shadow">
								...
								<div class="card-body">
									...
									<input type="text" value="<?= $sekolah->nama_sekolah ?>" readonly class="form-control mt-2 mb-2">
									<strong>Nama Kepala Sekolah : </strong><br>
									<input type="text" value="<?= $sekolah->nama_kepsek ?>" readonly class="form-control mt-2 mb-2">
									<strong>No Telepon Sekolah : </strong><br>
									<input type="text" value="<?= $sekolah->no_telepon ?>" readonly class="form-control mt-2 mb-2">
									<strong>Alamat Sekolah : </strong><br>
									<input type="text" value="<?= $sekolah->alamat ?>" readonly class="form-control mt-2">
								</div>
							</div>
						</div>
